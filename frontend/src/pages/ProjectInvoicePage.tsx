    ...
    (async () => {
      try {
        ...
        const existing = Array.isArray(invoices)
          ...
          : undefined;
        const storedRaw = readStoredInvoiceDraft(id);
        ...
        setDraft({
          ...
          dueDate:
            existing?.dueDate?.slice(0, 10) ?? due.toISOString().slice(0, 10),
          ...
          billToName: project.client.contactName?.trim() || project.client.name,
          ...
          <div className='inv-toolbar-scroll'>
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) => patchDraft({ authorizedName: e.target.value })}
